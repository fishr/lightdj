...
public class VisualizationEngineClassifier extends VisualizationEngine {	
	...
	public VisualizationEngineClassifier(AudioFormat format, double videoDelaySec) {
...
//		channels[3] = rgbController.getBlue();
		...
		// Don't have any specific channels to output
		return null;
	}


	@Override
	protected void renderVisuals(RenderFrame renderFrame) {
//		if (!silent) {
